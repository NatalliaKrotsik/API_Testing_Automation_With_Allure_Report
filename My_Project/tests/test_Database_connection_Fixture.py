...
@allure.feature("Database Connection")
@allure.story("Verify connected database name")
@allure.severity(allure.severity_level.NORMAL)
@allure.title("Test DB name is 'TestDB'")
@allure.description("This test validates the name of the database connected during testing.")
def test_db_name(db_connection):
    with allure.step("Checking database name"):
